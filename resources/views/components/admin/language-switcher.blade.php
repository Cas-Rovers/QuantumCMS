<div class="dropdown end-0 rounded-3 language-switcher">
    <button type="button" class="btn btn-secondary dropdown-toggle dropdown-btn" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="{{ Vite::asset('resources/assets/admin/media/images/flags/' . $current_locale . '.svg') }}" alt="{{ $current_locale }}" class="me-2">
            ...
            @if($locale === $current_locale)
                <li>
                    <a class="dropdown-item active" href="#">
                        <img src="{{ Vite::asset('resources/assets/admin/media/images/flags/' . $locale . '.svg') }}" alt="{{ $locale }}" class="me-2">
                        {{ $full_locale_name }}
                    </a>
                </li>
            @else
